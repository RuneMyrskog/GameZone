//static copy of genre data fetched from api, this is just to get the list of genres, since it
//remains the same this local copy is to speed up user experience by shipping this data with the app itself
